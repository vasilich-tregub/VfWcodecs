...
LRESULT WINAPI DriverProc(DWORD_PTR dwDriverID, HDRVR hDriver, UINT uiMessage, LPARAM lParam1, LPARAM lParam2)
{
    ...
    case ICM_COMPRESS_QUERY:
        ...
        if (jxsvfw_compress_query((PBITMAPINFO)lParam1, (PBITMAPINFO)lParam2))
            return ICERR_OK;
        else
    ...
    case ICM_COMPRESS_GET_FORMAT:
        ...
        if (jxsvfw_compress_get_format((PBITMAPINFO)lParam1, (PBITMAPINFO)lParam2))
            return ICERR_OK;
        else
            return ICERR_BADFORMAT;
    ...
    case ICM_COMPRESS_GET_SIZE:
        ...
        return jxsvfw_compress_max_size(/*this, */(PBITMAPINFO)lParam1, (PBITMAPINFO)lParam2);
    ...
    case ICM_COMPRESS_FRAMES_INFO:
        ...
        if (lParam1)
        {
            return jxsvfw_compress_frames_info((ICCOMPRESSFRAMES*)lParam1, (size_t*)lParam2);
        }
        return ICERR_ERROR;

    case ICM_COMPRESS_BEGIN:
        // start compression stream
        if (jxsvfw_compress_begin((PBITMAPINFO)lParam1, (PBITMAPINFO)lParam2))
            return ICERR_OK;
        else
            return ICERR_BADFORMAT;
    ...
    case ICM_COMPRESS:
        // compress a frame
        if (jxsvfw_compress((ICCOMPRESS*)lParam1, lParam2))
            return ICERR_OK;
        else
            return ICERR_ERROR;

    case ICM_COMPRESS_END:
        return jxsvfw_compress_end();

        /* DECODER MESSAGES */

    case ICM_DECOMPRESS_BEGIN:
        return jxsvfw_decompress_begin((BITMAPINFO*)lParam1, (BITMAPINFO*)lParam2);

    case ICM_DECOMPRESS:
        if (jxsvfw_decompress((ICDECOMPRESS*)lParam1, lParam2))
            return ICERR_OK;
        else
            return ICERR_ERROR;

    case ICM_DECOMPRESS_END:
        return jxsvfw_decompress_end();

    case ICM_DECOMPRESS_GET_FORMAT:
        return jxsvfw_decompress_get_format((BITMAPINFO*)lParam1, (BITMAPINFO*)lParam2);

    case ICM_DECOMPRESS_QUERY:
        return jxsvfw_decompress_query((BITMAPINFO*)lParam1, (BITMAPINFO*)lParam2);
